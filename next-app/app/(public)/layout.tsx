        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-4">
              {user ? (
                <Button asChild variant="outline" size="sm" className="font-medium text-foreground"><Link href="/client">My Portal</Link></Button>
              ) : (
                <SignInButton />
              )}
        ...
        <div className={cn("lg:hidden border-t border-border bg-background overflow-hidden transition-all duration-300 ease-in-out", mobileOpen ? "max-h-[min(70vh,32rem)] opacity-100 overflow-y-auto" : "max-h-0 opacity-0 border-t-0")}>
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-2 flex flex-col gap-3">
              {user ? (
                <Button asChild variant="outline" size="sm" className="w-full font-medium"><Link href="/client">My Portal</Link></Button>
              ) : (
                <SignInButton />
              )}
