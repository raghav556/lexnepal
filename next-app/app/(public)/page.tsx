...
import { RevealText, FadeInUp, HoverGlowCard, PREMIUM_EASE } from "@/components/ui/animations";
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: PREMIUM_EASE }} className="max-w-xl min-w-0 w-full">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2 mt-4 sm:mt-6 text-xs sm:text-sm text-primary-foreground/60 font-medium">
                ...
                <Link href="/consultation" className="text-accent hover:text-accent/80 transition-colors inline-flex items-center gap-1">Book Consultation <ArrowRight className="w-3 h-3" /></Link>
                <Link href="/practice-areas" className="hover:text-primary-foreground transition-colors">Practice Areas</Link>
                <Link href="/lawyers" className="hover:text-primary-foreground transition-colors">Our Team</Link>
              </div>
            </motion.div>
          </motion.div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-background border-t border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-w-0">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-12 gap-4">
              ...
              <FadeInUp delay={0.2}>
                <Button asChild variant="outline" className="shrink-0 group w-full sm:w-auto"><Link href="/blog">View All Insights <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" /></Link></Button>
              </FadeInUp>
            </div>
