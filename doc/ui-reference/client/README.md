...
1. The authoritative owner-approved source is `LexNepal_Client_UI_Upgrade_Source_of_Truth_v1.0.docx`.
2. The Markdown file `LexNepal_Client_UI_Upgrade_Source_of_Truth_v1.0.md` is a machine-readable companion only.
