...
All 13 phases in the master plan are now `PASS_LOCAL`. The final complete Chromium suite passed
twice at 28/28, the full production-shaped harness passed 23/23, and the optimized localhost
production rehearsal passed health, readiness, CSS, security-header, and public deep-link checks.

## Completed local evidence

- 83 active page routes and 169 API route files are inventoried and mapped; URL-preservation and
...
- CMS, matters, work management, finance, CRM, communications, documents, signatures, analytics,
...
- The performance fixture covered 120 clients, 250 cases, 500 documents, 150 invoices, and 200
...
- SMS, live payments, hosted identity, court-data providers, and other external services remain
...
Use `npm run db:seed` if demo accounts need to be recreated. Full setup, stop, testing, backup, and
...
4. Configure production identity, HTTPS/TLS, DNS, secure cookies, trusted origins, and edge/WAF rate
   limits.
5. Contract and verify real email, SMS, payment, OCR/CDR, and any court-data providers; complete
