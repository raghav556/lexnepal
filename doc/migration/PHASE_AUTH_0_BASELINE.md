...
| C5  | Admin mobile logout   | Mobile menu (if present) → Sign Out | `/sign-in` _(known gap pre-Phase 2)_ |
| C6  | Staff mobile logout   | Mobile menu → Sign Out              | `/sign-in` _(known gap pre-Phase 2)_ |
...
| E2  | Logged in header  | Visit `/` while signed in              | “My Portal” links to correct portal _(no logout on public site — known gap)_ |
