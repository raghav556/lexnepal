export const queryKeys = {
  ...
  clients: {
    ...
    myTeam: ["clients", "me", "team"] as const,
  ...
  cms: {
    ...
    resource: (slug: string) => ["cms", "public", "resource", slug] as const,
  ...
  financial: {
    ...
    invoice: (id: string) => ["financial", "invoice", id] as const,
    myPayments: ["financial", "payments", "mine"] as const,
