// @ts-expect-error pdfjs-dist does not expose complete declarations for this browser-only adapter.
import * as pdfjsLib from "pdfjs-dist";
// @ts-expect-error mammoth's bundled declaration is incompatible with this browser-only import.
