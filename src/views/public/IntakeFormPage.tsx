    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4 text-center">
        ...
        <p className="text-muted-foreground max-w-md mb-6">
          This intake link is no longer valid. If you believe this is an error, please contact
          Srimar Law directly.
        </p>
        <Link href="/">
  ...
  if (leadData.lead.intakeSubmitted || submitted) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4 text-center">
        ...
        <p className="text-muted-foreground max-w-md mb-6">
          Thank you for providing your details. Our legal team will review your information and
          contact you shortly to schedule a consultation.
        </p>
        <Link href="/">
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            Please provide your details so we can best assist you with your legal matter. All
        ...
        <div className="bg-card border border-border rounded-xl shadow-xs p-6 sm:p-8">
          ...
          {step === 1 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-medium">
                    Citizenship Number <span className="text-destructive">*</span>
                  </label>
                  <Input
                    value={citizenshipNo}
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="e.g. Ward No. 10, Baneshwor, Kathmandu"
                />
              </div>
          ...
          {step === 2 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              <h2 className="text-xl font-semibold text-foreground mb-4 border-b border-border pb-2">
                2. Legal Matter Details
              </h2>

              <div className="space-y-1.5">
                <label className="text-sm font-medium">
                  Primary Practice Area <span className="text-destructive">*</span>
                </label>
              ...
              <div className="space-y-1.5">
                <label className="text-sm font-medium">
                  Brief Description of the Issue <span className="text-destructive">*</span>
                </label>
                <textarea
          ...
          {step === 3 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
              <h2 className="text-xl font-semibold text-foreground mb-4 border-b border-border pb-2">
                3. Initial Documents (Optional)
              </h2>

              <p className="text-sm text-muted-foreground mb-4">
                Please upload any relevant documents (e.g. contracts, land deeds, notices, ID
                copies) that will help us understand your case better before the consultation.
              </p>
