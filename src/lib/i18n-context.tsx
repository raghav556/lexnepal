...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "tasks.client_checklist_sub": "Action items your legal team shared with you. Contact your lawyer to mark items complete.",
  ...
  ne: {
    ...
    "tasks.client_checklist_sub": "तपाईंको कानुनी टोलीले सेयर गरेका कार्यहरू। पूरा गर्न आफ्नो वकिललाई सम्पर्क गर्नुहोस्।",
