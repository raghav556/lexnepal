...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "status.todo": "To Do",
    "status.done": "Done",
    "portal.finance.title": "Finance & Compliance",
    "portal.finance.description": "Invoices, collections, and trust ledger.",
    ...
    "portal.analytics.description": "Firm performance, revenue metrics, and utilization tracking.",
    ...
    "portal.time.title": "Time Tracker",
    "portal.time.description":
      "Log billable hours against matters with stopwatch or manual entries.",
  ...
  ne: {
    ...
    "status.done": "सम्पन्न",
    "portal.finance.title": "वित्त र अनुपालन",
    "portal.finance.description": "बिल, संकलन, र ट्रस्ट खाता।",
    ...
    "portal.time.title": "समय ट्र्याकर",
    "portal.time.description":
      "स्टपवाच वा म्यानुअल प्रविष्टिबाट मुद्दामा बिल योग्य घण्टा लगाउनुहोस्।",
