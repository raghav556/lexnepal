...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "nav.identity_verification": "Identity Verification",
    "nav.signatures": "E-Signatures",
    "nav.sign_documents": "Sign Documents",
    "nav.book_appointment": "Book Appointment",
    "nav.messages": "Messages",
    "nav.notifications": "Notifications",
    "nav.profile": "Profile & Settings",
    "nav.client_profile": "Profile",
    "nav.more": "More",
    "action.add": "Add New",
    "action.edit": "Edit",
    ...
    "client.support_title": "Need Help?",
    "client.support_body": "Our team is here to support you.",
    "client.support_action": "Message Legal Team",
    "client.support_quote": "Your Trust Our Commitment",
  ...
  ne: {
    ...
    "nav.home": "गृह",
    "nav.cases": "मुद्दाहरू",
    "nav.my_matters": "मेरा मुद्दाहरू",
    "nav.matters": "मुद्दाहरू",
    ...
    "client.support_title": "सहयोग चाहियो?",
    "client.support_body": "हाम्रो टोली तपाईंलाई सहयोग गर्न तयार छ।",
    "client.support_action": "कानुनी टोलीलाई सन्देश",
    "client.support_quote": "तपाईंको विश्वास, हाम्रो प्रतिबद्धता",
    ...
    "status.inquiry": "सोधपुछ",
    "status.closed": "बन्द",
    "status.closed_won": "बन्द — जित",
    "status.closed_lost": "बन्द — हार",
    "status.won": "जित",
    "status.lost": "हार",
    "status.settled": "मिलापत्र",
    "status.withdrawn": "फिर्ता",
    "status.other": "अन्य",
