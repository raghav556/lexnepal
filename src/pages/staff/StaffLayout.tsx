...
import { Scale, LayoutDashboard, FolderOpen, CalendarDays, FileText, CheckSquare, Clock, Users, LogOut, Menu, X, Bell, Loader2, Calendar, BookOpen, User as UserIcon, ChevronUp, Globe } from "lucide-react";
...
function StaffSidebar({ onOpenChat }: { onOpenChat: () => void }) {
      ...
      <Authenticated>
        <StaffRoleGuard>
          <div className="flex h-screen overflow-hidden bg-background">
            <StaffSidebar onOpenChat={() => setChatOpen(true)} />
