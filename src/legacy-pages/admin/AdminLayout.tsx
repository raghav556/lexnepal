...
import { AuthSessionGate } from "@/components/auth/AuthSessionGate.tsx";
...
/** Mobile top bar + drawer — stacked above main, not beside it in the flex row */
      ...
      <AuthSessionGate
        ...
        loadingFallback={
          <div className="min-h-screen flex items-center justify-center bg-background">
            <Skeleton className="w-56 h-screen hidden md:block" />
          </div>
        }
      >
        <AdminRoleGuard>
